...
PAYMENTS_TOKEN = "381764678:TEST:174936 2026-04-09 13:16"
...
async def start(message: Message):
    await message.answer_photo(
        ...
        caption=(
            "🔥 <b>Доступ к обучению обклейки полеуритановой пленкой</b>\n\n"
            "💰 15000₽ / 365 дней\n"
            "📈 матерьялы, полный цикл обучения, все аспекты бизнеса"
        ),
